...
class OpenAlgo extends OrderAPIClass {
  ...
  // Data API methods
  quotes(params) {
    return this._dataAPI.quotes(params);
  }
  depth(params) {
    return this._dataAPI.depth(params);
  }
  symbol(params) {
    return this._dataAPI.symbol(params);
  }
  history(params) {
    return this._dataAPI.history(params);
  }
  intervals() {
    return this._dataAPI.intervals();
  }
  expiry(params) {
    return this._dataAPI.expiry(params);
  }
  search(params) {
    return this._dataAPI.search(params);
  }
  multiQuotes(params) {
    return this._dataAPI.multiQuotes(params);
  }
  optionChain(params) {
    return this._dataAPI.optionChain(params);
  }
  optionSymbol(params) {
    return this._dataAPI.optionSymbol(params);
  }
  syntheticFuture(params) {
    return this._dataAPI.syntheticFuture(params);
  }
  optionGreeks(params) {
    return this._dataAPI.optionGreeks(params);
  }
  instruments(params) {
    return this._dataAPI.instruments(params);
  }

  // Account API methods
  funds() {
    return this._accountAPI.funds();
  }
  orderbook() {
    return this._accountAPI.orderbook();
  }
  tradebook() {
    return this._accountAPI.tradebook();
  }
  positionbook() {
    return this._accountAPI.positionbook();
  }
  holdings() {
    return this._accountAPI.holdings();
  }
  margin(params) {
    return this._accountAPI.margin(params);
  }
  holidays(params) {
    return this._accountAPI.holidays(params);
  }
  timings(params) {
    return this._accountAPI.timings(params);
  }
  telegram(params) {
    return this._accountAPI.telegram(params);
  }

  // Analyzer API methods
  analyzerstatus() {
    return this._analyzerAPI.analyzerstatus();
  }
  analyzertoggle(params) {
    return this._analyzerAPI.analyzertoggle(params);
  }
  ...
  connect({ onOpen = () => {}, onMessage = () => {}, onClose = () => {} }) {
    ...
    return this._wsClient.connect({ onOpen, onMessage, onClose });
  }
